...
On 2026-09-15, the study and FSRS flow was validated by automated tests: all four ratings, persisted scheduler state, review-log atomicity and migration behavior passed. On 2026-09-16, automated study-queue tests covered future short-term cards scheduled today, exclusion of tomorrow's cards, exact due-time availability and due-order preservation. Manual Android validation of deck-to-study navigation, nested-deck study selection, displayed due times and delayed reappearance remains the next validation step. Native iOS validation remains pending.
